...
- list:
  - listitem: Quickly view and adjust your balance as needed.
  - listitem: Access a complete history of all your transactions. Each transaction includes details like type, amount, and date.
  - listitem: Need a record? Export your entire transaction history as a spreadsheet with just a click.
- text: Skip
- button "Next"
- img
- radio [checked]
